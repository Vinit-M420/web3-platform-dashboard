...
export default function Main({ isSidebarOpen }: MainProps) {
    ...
    return (
        <div className={`flex-1 flex flex-col transition-all duration-200 bg-gray-50 p-4 mx-auto dark:bg-black shadow-md sm:ml-20 ml-0 z-10
                        sm:w-[calc(100vw-5rem)] w-screen sm:mt-0 mt-15`}>
                <Top />
            <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr] lg:grid-cols-[1.5fr_1fr_1fr] gap-5 p-4 border border-gray-200 dark:border-gray-700 border-t-0 border-b-0">
                <Collateral />
                <Capital />

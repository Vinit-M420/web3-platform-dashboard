    ...
    return (
        <div className="flex flex-wrap gap-y-4 justify-center sm:justify-between items-center border border-gray-200 dark:border-gray-700 px-4 sm:px-6 md:px-8 py-2 sm:py-3 md:py-4 bg-gray-50 dark:bg-black rounded-t-xl">
            ...
            <div className='flex gap-2 sm:gap-3 md:gap-4 items-center dark:text-white text-gray-700 min-w-fit justify-center sm:justify-end w-full sm:w-auto'>
                <div className='dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md cursor-pointer h-fit p-1.5 sm:p-2 md:p-2 flex items-center justify-center mx-auto sm:mx-0'
                ...
                <div className='dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md cursor-pointer h-fit p-1.5 sm:p-2 md:p-2 flex gap-1.5 sm:gap-2 items-center mx-auto sm:mx-0'>
                    <Settings className='w-5 h-5 sm:w-6 sm:h-6 md:w-6 md:h-6' />
                    <p className='text-xs sm:text-sm md:text-base'>Settings</p>
                </div>
                <div className='dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md cursor-pointer h-fit p-1.5 sm:p-2 md:p-2 dark:flex hidden items-center justify-center mx-auto sm:mx-0' 
                    onClick={() => setTheme("light")}> 
                    <Moon className='w-5 h-5 sm:w-6 sm:h-6 md:w-6 md:h-6' /> 
                </div>
                <div className='dark:bg-gray-800 border border-gray-200 rounded-md cursor-pointer h-fit p-1.5 sm:p-2 md:p-2.5 dark:hidden flex items-center justify-center mx-auto sm:mx-0' 

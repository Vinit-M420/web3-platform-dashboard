...
export default function Top() {
    ...
    return (
        <div className="flex justify-between items-center border border-gray-200 dark:border-gray-700 px-8 py-4 
        bg-gray-50 dark:bg-black rounded-t-xl">
            ...
            <div className='flex gap-2 items-center dark:text-white text-gray-700'>
                <div className='dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md cursor-pointer h-fit p-2'
                    onClick={() => setNotificationOn(!notificationOn)}>
                    <BellRing className={`h-6 w-6 ${notificationOn ? `dark:fill-gray-200 fill-gray-700` : ``}`} /> 
                
                </div>
                <div className='dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md cursor-pointer h-fit p-2 flex gap-2'>
                <Settings className='h-6 w-6' />
                <p>Settings</p>
                </div>

                <div className='dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md cursor-pointer h-fit p-2 dark:block hidden' 

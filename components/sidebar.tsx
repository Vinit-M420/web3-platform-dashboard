...
export default function Sidebar({ onToggle }: SidebarProps) {
    ...
    if (!isOpen){
    return (
        <div className="hidden md:block fixed top-0 left-0 min-h-screen w-20 bg-gray-100 font-sans dark:bg-gray-950 border-r dark:border-gray-700
            ...
            dark:text-gray-300 text-gray-500 cursor-pointer group'>      
                ...
                <div className="absolute left-full ml-2 px-2 py-1 bg-gray-800 text-white text-sm rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-150">
                    Expand
                </div>
            </div>
